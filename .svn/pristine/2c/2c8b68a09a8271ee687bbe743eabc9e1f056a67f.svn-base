...
<div style="background:#fff">
  ...
  <div class="center" @keyup.enter="show()" :style="{backgroundImage: 'url(' +bImg + ')'}">
    <el-form :model="user" ref="user" label-position="left" label-width="0px" class="demo-ruleForm login-container">
      <h3 class="title">业务员登录</h3>
      <el-form-item prop="account">
        <el-input type="text" v-model="user.account" auto-complete="off" placeholder="请输入用户名">
          <template slot="prepend"><img src="../../assets/img/accont.png" style="width:20px;height:20px;" alt=""></template>
        </el-input>
      </el-form-item>
      <el-form-item prop="checkPass">
        <el-input type="password" v-model="user.checkPass" auto-complete="off" placeholder="请输入密码">
          <template slot="prepend"><img src="../../assets/img/pass.png" style="width:20px;height:20px;" alt=""></template>
        </el-input>
      </el-form-item>
      ...
      <el-button type="primary" style="width:100%;background-color:#0066cc;border-color:#0066cc" @click.native.prevent="handleSubmit2" :loading="logining">登 录</el-button>
      <span style="color:#ff4949;text-align:center;display: inherit;font-size:12px;">{{user.Verification}}</span>
      <span class="title" style="display: block;">忘记密码 请联系客服<br>0 2 9-8 8 4 4 5 5 3 4</span>
    </el-form>
  </div>
  <div class="news">
    <div class="notice">
